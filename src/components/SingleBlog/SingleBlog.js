          ...
          <div className='blog-details'>
            <div className='blog-info flex align-center'>
              ...
              <div className='blog-info-item flex align-center'>
                ...
                <span className='blog-info-item-text font-rubik fw-5'>{typeof blog.reactions === "number" ? blog.reactions : "No reactions"}</span>
              </div>
            </div>
                  ...
                  return (
                    <div className='recent-blogs-item' key = {blog.id}>
                      ...
                      <div className='flex align-center'>
                        ...
                        <span>{typeof blog.reactions === "number" ? blog.reactions : JSON.stringify(blog.reactions)}</span>
                      </div>
                    </div>
                  )
                })
